...
export default function Chart() {
    ...
    return (
        <section id="bigo-chart" className={style.sectionwrapper}>
            <h3 className={style.title}>Big-O Complexity Chart</h3>
            <div className={style.container}>
                <svg id="chart" viewBox="0 0 800 500">
                    ...
                    <text x="665" y="438" fill="black">O(log n), O(1)</text>
                    ...
                    <text className={style.label} x="0" y="0" transform="translate(30 230) rotate(-90)" fill="black">Operations</text>
                    <text className={style.label} x="0" y="0" transform="translate(420 470)" fill="black">Elements</text>
                </svg>
            </div>
        </section>
    )
